...
class ReclamationController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, MailerInterface $mailer,UserRepository $repU): Response
    {

        //whatsapp
        $sid    = "AC0caafa1f675f3f429a7df499c1e754b7";
        $token  = "505631bbd347a466936cf14224516a9a";
           ...
           try {
                $message = $twilio->messages->create(
                    ...
                    [
                        ...
                        "body" => $user->getName()." a envoyee une Reclamation , vous pouvez le contacter sur ".$user->getPhone(),
                ...
                $whatsappNotif->setText($user->getName().": a ajouter une reclamation ");
